...
(function () {
  ...
  const MATERIALS = [
    ...
    { id:"ABS", name:"ABS", cat:"amorphe", E_GPa:2.1, izod_kJm2:18, Tg_C:100, HDT_C:85, CTI:250, UL94:"HB", price_eurkg:2.8, transparent:false, uv_ok:"faible", chem:["alcool"], food:false, medical:false, fr_grade:false, min_wall_mm:1.2, elongation_pct:20, hinge_ok:false, snap_ok:true, overmold_ok:true },
    { id:"PC", name:"PC transparent (UV)", cat:"amorphe", E_GPa:2.4, izod_kJm2:70, Tg_C:145, HDT_C:120, CTI:250, UL94:"V-2", price_eurkg:5.2, transparent:true, uv_ok:"fort", chem:["alcool","detergents"], food:true, medical:false, fr_grade:false, min_wall_mm:2.0, elongation_pct:120, hinge_ok:false, snap_ok:true, overmold_ok:true },
    { id:"PCABS_FR", name:"PC-ABS FR (V-0)", cat:"amorphe-blend", E_GPa:2.3, izod_kJm2:45, Tg_C:115, HDT_C:100, CTI:250, UL94:"V-0", price_eurkg:6.1, transparent:false, uv_ok:"moyen", chem:["alcool","detergents"], food:false, medical:false, fr_grade:true, min_wall_mm:2.0, elongation_pct:80, hinge_ok:false, snap_ok:true, overmold_ok:true },
    { id:"PA6", name:"PA6 (nylon)", cat:"semi-cristallin", E_GPa:2.6, izod_kJm2:6, Tg_C:50, HDT_C:180, CTI:600, UL94:"HB", price_eurkg:3.2, transparent:false, uv_ok:"faible", chem:["huiles"], food:true, medical:false, fr_grade:false, min_wall_mm:1.2, elongation_pct:60, hinge_ok:false, snap_ok:true, overmold_ok:true, absorbs_water:true },
    { id:"PA66_GF30", name:"PA66 GF30", cat:"semi-cristallin", E_GPa:7.0, izod_kJm2:12, Tg_C:70, HDT_C:210, CTI:600, UL94:"HB", price_eurkg:4.4, transparent:false, uv_ok:"moyen", chem:["huiles"], food:false, medical:false, fr_grade:false, min_wall_mm:1.5, elongation_pct:2, hinge_ok:false, snap_ok:false, overmold_ok:true, absorbs_water:true },
    { id:"POM", name:"POM (acétal)", cat:"semi-cristallin", E_GPa:2.8, izod_kJm2:6, Tg_C:-50, HDT_C:100, CTI:600, UL94:"HB", price_eurkg:3.9, transparent:false, uv_ok:"faible", chem:["huiles","solvants"], food:true, medical:false, fr_grade:false, min_wall_mm:1.0, elongation_pct:40, hinge_ok:false, snap_ok:true, overmold_ok:true },
    { id:"PBT_GF30", name:"PBT GF30", cat:"semi-cristallin", E_GPa:8.0, izod_kJm2:10, Tg_C:50, HDT_C:200, CTI:600, UL94:"V-2", price_eurkg:4.6, transparent:false, uv_ok:"moyen", chem:["huiles","alcool"], food:false, medical:false, fr_grade:false, min_wall_mm:1.2, elongation_pct:3, hinge_ok:false, snap_ok:false, overmold_ok:true },
