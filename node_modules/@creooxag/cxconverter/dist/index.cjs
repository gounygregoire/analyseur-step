...
const name = "@creooxag/cxconverter";
...
var IfcDbWasm = /* @__PURE__ */ (() => {
  return async function(moduleArg = {}) {
    ...
    function findWasmBinary() {
      ...
      return new URL("ifcdb.wasm", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href))).href;
    }
...
`;
    ...
    var ASM_CONSTS = { 1473352: () => {
      console.error("progress callback is not set.");
    } };
    var wasmImports = { a: ___cxa_throw, j: ___syscall_fcntl64, G: ___syscall_ioctl, H: ___syscall_openat, r: ___syscall_renameat, s: ___syscall_rmdir, w: ___syscall_stat64, t: ___syscall_unlinkat, u: __abort_js, L: __embind_finalize_value_object, m: __embind_register_bigint, R: __embind_register_bool, P: __embind_register_emval, l: __embind_register_float, f: __embind_register_function, c: __embind_register_integer, b: __embind_register_memory_view, Q: __embind_register_std_string, g: __embind_register_std_wstring, O: __embind_register_value_object, M: __embind_register_value_object_field, S: __embind_register_void, N: __emval_as, d: __emval_call, q: __emval_decref, F: __emval_get_global, e: __emval_get_method_caller, o: __emval_incref, T: __emval_is_string, n: __emval_run_destructors, p: __emval_take_value, x: __gmtime_js, y: __localtime_js, z: __tzset_js, J: _clock_time_get, K: _emscripten_asm_const_int, I: _emscripten_date_now, v: _emscripten_resize_heap, k: _emscripten_sleep, C: _environ_get, D: _environ_sizes_get, h: _fd_close, B: _fd_fdstat_get, E: _fd_read, A: _fd_seek, i: _fd_write };
    var wasmExports = await createWasm();
    wasmExports["V"];
    var ___getTypeName = wasmExports["W"];
    var _malloc = wasmExports["X"];
    var _free = wasmExports["Y"];
    var _main = Module["_main"] = wasmExports["Z"];
    var __emscripten_stack_alloc = wasmExports["_"];
    Module["dynCall_ii"] = wasmExports["$"];
    Module["dynCall_vi"] = wasmExports["aa"];
    Module["dynCall_vii"] = wasmExports["ba"];
    Module["dynCall_iii"] = wasmExports["ca"];
    Module["dynCall_viii"] = wasmExports["da"];
    Module["dynCall_v"] = wasmExports["ea"];
    Module["dynCall_diiii"] = wasmExports["fa"];
    Module["dynCall_viif"] = wasmExports["ga"];
    Module["dynCall_iiiii"] = wasmExports["ha"];
    Module["dynCall_iiii"] = wasmExports["ia"];
    Module["dynCall_ddd"] = wasmExports["ja"];
    Module["dynCall_i"] = wasmExports["ka"];
    Module["dynCall_fii"] = wasmExports["la"];
    Module["dynCall_viiii"] = wasmExports["ma"];
    Module["dynCall_iiiiii"] = wasmExports["na"];
    Module["dynCall_idd"] = wasmExports["oa"];
    Module["dynCall_jiji"] = wasmExports["pa"];
    Module["dynCall_iidiiii"] = wasmExports["qa"];
    Module["dynCall_viijii"] = wasmExports["ra"];
    Module["dynCall_iiiiiiiii"] = wasmExports["sa"];
    Module["dynCall_iiiiiii"] = wasmExports["ta"];
    Module["dynCall_iiiiij"] = wasmExports["ua"];
    Module["dynCall_iiiiid"] = wasmExports["va"];
    Module["dynCall_iiiiijj"] = wasmExports["wa"];
    Module["dynCall_iiiiiiii"] = wasmExports["xa"];
    Module["dynCall_iiiiiijj"] = wasmExports["ya"];
    Module["dynCall_viiiiii"] = wasmExports["za"];
    Module["dynCall_viiiii"] = wasmExports["Aa"];
    var _asyncify_start_unwind = wasmExports["Ba"];
    var _asyncify_stop_unwind = wasmExports["Ca"];
    var _asyncify_start_rewind = wasmExports["Da"];
    var _asyncify_stop_rewind = wasmExports["Ea"];
...
const _IfcWasmConverterLoader = class _IfcWasmConverterLoader {
  ...
  static async getInstance(userUrlPrefix = "remote") {
...
class IfcConverter {
  constructor() {
    ...
    __publicField(this, "metaDataGlobal");
    __publicField(this, "handleGLTFclb");
    __publicField(this, "handleMetaDataClb");
    __publicField(this, "GLTFs", []);
  }
  async init(inputOptions = IfcConverter.getDefaultInputOptions()) {
  ...
  static async create(inputOptions = IfcConverter.getDefaultInputOptions()) {
    let ifcConverter = new IfcConverter();
    await ifcConverter.init(inputOptions);
    return ifcConverter;
  }
  loadModel(data, loadOptions = IfcConverter.getDefaultLoadOptions()) {
  ...
  registerGltfChunkDoneCallback(handleGLTFclb) {
    this.handleGLTFclb = handleGLTFclb;
  }
  registerMetaDataCompleteCallback(handleMetaDataClb) {
    this.handleMetaDataClb = handleMetaDataClb;
  }
  registerGltfCompleteCallback(gltfCompleteCallback) {
...
async function ifc2gltf(ifcData, params = { remote: true }) {
...
exports.IfcConverter = IfcConverter;
exports.IfcWasmConverterLoader = IfcWasmConverterLoader;
exports.ifc2gltf = ifc2gltf;
