# step2glb_ocp.py — STEP -> GLB (une géo par face)
...
from OCP.TopoDS import topods_Face   # <-- IMPORT CRUCIAL

def triangulate_shape_faces(shape, lin_defl=0.05, ang_rad=0.25, unit_scale=1.0):
    # Force la tessellation OCCT (sinon Triangulation_s retourne None)
